...
namespace BackgroundProgramKeeper
{
    static class Program
    {
        ...
        public static string SVC_NAME = "BackgroundProgramKeeper";
        public static string SVC_DESC = "A tool to keep windows background programs running";
        ...
        public static int Main(string[] args)
        {
            ...
            if (Environment.UserInteractive)
            {
                ...
                {
                    bool canRun = false;
                    mutex = new Mutex(true, "BackgroundProgramKeeper.Instance", out canRun);
